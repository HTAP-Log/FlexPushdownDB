...
#ifndef NORMAL_NORMAL_UTIL_INCLUDE_NORMAL_UTIL_CAFUTIL_H
#define NORMAL_NORMAL_UTIL_INCLUDE_NORMAL_UTIL_CAFUTIL_H

#include <caf/all.hpp>

namespace normal::util {

  inline constexpr ::caf::type_id_t Operator_first_custom_type_id = ::caf::first_custom_type_id;
  inline constexpr ::caf::type_id_t OperatorContext_first_custom_type_id = ::caf::first_custom_type_id + 100;
  inline constexpr ::caf::type_id_t OperatorActor_first_custom_type_id = ::caf::first_custom_type_id + 200;
  inline constexpr ::caf::type_id_t OperatorActor2_first_custom_type_id = ::caf::first_custom_type_id + 300;
  inline constexpr ::caf::type_id_t SegmentCacheActor_first_custom_type_id = ::caf::first_custom_type_id + 400;
  inline constexpr ::caf::type_id_t Envelope_first_custom_type_id = ::caf::first_custom_type_id + 500;
  inline constexpr ::caf::type_id_t Message_first_custom_type_id = ::caf::first_custom_type_id + 600;
  inline constexpr ::caf::type_id_t Type_first_custom_type_id = ::caf::first_custom_type_id + 700;
...
#endif //NORMAL_NORMAL_UTIL_INCLUDE_NORMAL_UTIL_CAFUTIL_H
