# Arrow
set(ARROW_VERSION "apache-arrow-3.0.0")
...
set(ARROW_DEPENDENCIES_STATIC_LIB ${ARROW_LIB_DIR}/${CMAKE_STATIC_LIBRARY_PREFIX}arrow_bundled_dependencies${CMAKE_STATIC_LIBRARY_SUFFIX})
...
target_link_libraries(arrow_static INTERFACE ${ARROW_DEPENDENCIES_STATIC_LIB})
...
target_link_libraries(arrow_shared INTERFACE ${ARROW_DEPENDENCIES_STATIC_LIB})
