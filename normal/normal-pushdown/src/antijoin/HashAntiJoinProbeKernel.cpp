...
tl::expected<void, std::string> HashAntiJoinProbeKernel::joinBuildTupleSetIndex(const std::shared_ptr<TupleSetIndex> &tupleSetIndex) {
...
void HashAntiJoinProbeKernel::bufferOutputSchema(const std::shared_ptr<TupleSetIndex> &tupleSetIndex, const std::shared_ptr<TupleSet2> &tupleSet) {
