...
std::string Mode::toString() {
    switch (id_) {
        case ModeId::FullPullup:
            return "Full Pullup";
        case ModeId::FullPushdown:
            return "Full Pushdown";
        case ModeId::PullupCaching:
            return "Pullup Caching";
        case ModeId::HybridCaching:
            return "Hybrid Caching";
        case ModeId::HybridCachingLast:
            return "Hybrid Caching (Last)";
        case ModeId::Htap:
            return "HTAP";
        default:
            /*
